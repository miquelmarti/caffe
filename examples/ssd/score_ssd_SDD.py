...
model_name = "VGG_SDD_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/SDD/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/SDD/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/SDD/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/SDD/results/{}_score/".format(os.environ['HOME'], job_name)
...
# Stores the test image names and sizes. Created by data/SDD/create_list.sh
name_size_file = "data/SDD/val_small_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/SDD/labelmap_SDD.prototxt"
